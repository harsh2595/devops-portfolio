        ...
        <SiteShell>
            <section className="mx-auto max-w-7xl px-4 pb-12 pt-16 sm:px-6 lg:px-8">
                <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
                    <div>
                        <p className="text-sm uppercase tracking-[0.24em] text-cyan-200">About Me</p>
                        <h1 className="mt-3 max-w-4xl text-4xl font-semibold leading-tight text-white sm:text-5xl">
                            DevOps engineer focused on practical automation, dependable releases, and cloud systems that stay manageable.
                        </h1>
                    ...
                    <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6">
                        <p className="text-sm uppercase tracking-[0.24em] text-cyan-200">Career Snapshot</p>
                        <div className="mt-6 grid gap-4">
                            {experiences.map((role) => (
                                <div key={role.title} className="rounded-3xl border border-white/10 bg-slate-950/40 p-5">
                                    <p className="text-xs uppercase tracking-[0.18em] text-slate-400">{role.period}</p>
            ...
            <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="mb-8">
                    <p className="text-sm uppercase tracking-[0.24em] text-cyan-200">Capabilities</p>
            ...
            <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(34,211,238,0.14),rgba(249,115,22,0.1),rgba(255,255,255,0.05))] p-6 sm:p-8">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            <p className="text-sm uppercase tracking-[0.24em] text-cyan-100">Next Step</p>
